    ...
    public class CD_Carrito
    {
        ...
        public bool ExisteCarrito(int idcliente, int idproducto)
        {
            ...
            try
            {
                ...
                {
                    SqlCommand cmd = new SqlCommand("sp_ExisteCarrito", oconexcion);
        ...
        public bool OperacionCarrito(int idcliente, int idproducto, bool sumar, out string Mensaje)
        {
            ...
            try
            {
                using (SqlConnection oconexcion = new SqlConnection(Conexion.cn))
                {
                    SqlCommand cmd = new SqlCommand("sp_OperacionCarrito", oconexcion);
                    cmd.Parameters.AddWithValue("IdCliente", idcliente);
                    cmd.Parameters.AddWithValue("IdProducto", idproducto);
        ...
        public bool EliminarCarrito(int idcliente, int idproducto)
        {
            ...
            try
            {
                using (SqlConnection oconexcion = new SqlConnection(Conexion.cn))
                {
                    SqlCommand cmd = new SqlCommand("sp_EliminarCarrito", oconexcion);
                    cmd.Parameters.AddWithValue("IdCliente", idcliente);
                    cmd.Parameters.AddWithValue("IdProducto", idproducto);
                    cmd.Parameters.Add("Resultado", SqlDbType.Bit).Direction = ParameterDirection.Output;
                    cmd.CommandType = CommandType.StoredProcedure;
