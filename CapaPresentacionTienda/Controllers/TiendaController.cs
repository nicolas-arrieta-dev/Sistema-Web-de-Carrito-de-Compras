...
namespace CapaPresentacionTienda.Controllers
{
    public class TiendaController : Controller
    {
        ...
        public JsonResult ObtenerDepartamento()
        {
            ...
            olista = new CN_Ubicacion().ObteberDepartamento();
        ...
        public JsonResult ObtenerProvincia(string IdDepartamento)
        {
            ...
            olista = new CN_Ubicacion().ObteberProvincia(IdDepartamento);
            return Json(new { lista = olista }, JsonRequestBehavior.AllowGet);
        }
        ...
        public JsonResult ObtenerDistrito(string IdDepartamento, string IdProvincia)
        {
            ...
            olista = new CN_Ubicacion().ObteberDistrito(IdDepartamento, IdProvincia);
            return Json(new { lista = olista }, JsonRequestBehavior.AllowGet);
        }
        ...
        public async Task<JsonResult> ProcesarPago(List<Carrito> oListaCarrito, Venta oVenta)
        {
            ...
            Checkout_Order oCheckOutOrder = new Checkout_Order()
            {
                ...
                application_context = new ApplicationContext()
                {
                    ...
                    user_action = "PAY_NOW",
                    return_url = "https://localhost:44357/Tienda/PagoEfectuado",
                    cancel_url = "https://localhost:44357/Tienda/Carrito"
                }
            };
